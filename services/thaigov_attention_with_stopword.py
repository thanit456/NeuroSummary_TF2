...
MODEL_ATTN_PATH = './model/v6_not_remove_stopword_50_20_attention_best.h5'
# MODEL_ATTN_PATH = './model/200_20_v2.2_normal_best_200_20_attention_best.h5'

with open('./decode/dictionary/dict_t_50_20_v2_has_stop_word.pkl', 'rb') as f:
    dict_t = pickle.load(f)

with open('./decode/dictionary/rev_dict_t_50_20_v2_has_stop_word.pkl', 'rb') as f:
    rev_dict_t = pickle.load(f)

class AttentionWithStopwordInferencer(Inferencer):
    ...
    def get_name(self):
        return 'Attention LSTM w/ stopword'
